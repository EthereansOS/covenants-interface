export default function Entries(props) {
    return <>
        ...
        {props.entries.map((entry, entryIndex) => <div key={entry.title} className="row flex-column align-items-start mb-4">
            <div className="col-8">
                <p><b>{entry.title}</b> ({entry.operations.length} operations)</p>
            </div>
