    ...
    if(!generation) {
        return (<div>
            <div className="NUUUMobileVersion">
                <a className="web2ActionBTN" href="javascript:;" onClick={() => setGeneration("gen1")}>Gen1</a>
                <a className="web2ActionBTN" href="javascript:;" onClick={() => setGeneration("gen2")}>Gen2</a>
            </div>
        </div>);
    }
