/** This is the template of the Farming Extension. You can edit as you whish.
 *
 *  Just remember that constructor is not supported and following methods are MANDATORY:
 *
 *  function transferTo(uint256 amount) public
 *
 *  function backToYou(uint256 amount) payable public
 **/

//SPDX-License-Identifier: MIT
pragma solidity /* Insert solidity version here */;
pragma abicoder v2;
